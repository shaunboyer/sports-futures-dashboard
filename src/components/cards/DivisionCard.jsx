...
export default function DivisionCard({ bet, betData }) {
  const { teamRecord, divStandings, wins, losses, gamesRemaining, divRank, gamesBack, inFirst } =
    betData || {}
              ...
              <>
                ...
                >
                  <div
                    ...
                    style={{ backgroundColor: inFirst ? '#22c55e' : '#ef4444' }}
                  />
                  {inFirst ? 'In First' : 'Not First'}
                </div>
